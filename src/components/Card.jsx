...
import { clearCart, decreaseCount, increaseCount } from '../Redux/cartSlice'
            ...
            (<div>
                ...
                <div className='max-w-md ms-auto'>
                    ...
                    <div className='p-2'>
                        ...
                        <button 
                        onClick={handlePay}
                        className='px-4 py-2 w-full mt-5 bg-black text-white text-xs font-extralight font-poppins rounded-lg'>checkout</button>
